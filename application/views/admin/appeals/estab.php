                        ...
                        <div class="db-booking-item">
                            ...
                            <div class="booking-info">
                                ...
                                <ul class="booking_list transparent">
                                    <li><span><?php echo $item['name']." ".$item['surname']?></span></li>
                                </ul>
                            </div>
                            <ul class="buttons">
                                <?php if ($item['status'] == 0){ ?>
                                    <li><a href="<?php echo base_url('approve_appeal/'."3"."/".$item['id']) ?>" class="btn v2"><i class="ion-ios-checkmark-outline"></i> Approve</a></li>
                                    <li><a href="<?php echo base_url('reject_appeal/'."3"."/".$item['id']) ?>" class="btn v5"><i class="ion-ios-close-outline"></i> Reject</a></li>
