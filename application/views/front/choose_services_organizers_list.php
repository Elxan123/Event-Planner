                                ...
                                <li class="has-sub"><a href="# ">More Filters</a>
                                    <ul class="explore__form-checkbox-list half-filter">
                                        <div class="filter-checkbox">
                                            <p>Sort By Services</p>
                                            <?php foreach ($services as $item){ ?>
                                            <li><input class="serviceCh <?php echo $item['id'] ?>srv" id="<?php echo $item['id'] ?>check-a" type="checkbox" name="check" value="<?php echo $item['id'] ?>">
                                                <label for="<?php echo $item['id'] ?>check-a"><?php echo $item['name'] ?></label></li>
                                            <?php } ?>
                                        </div>
                                    </ul>
                                </li>
