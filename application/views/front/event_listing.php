    ...
    <div class="container-fluid no-pad-lr">
        <div class="row">
            <div class="col-md-12 no-padding">
                <div style="height: 50vh;" id="map_right_listing"></div>
            </div>
        </div>
    </div>
</div>
...
<div class="filter-wrapper style1 section-padding">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <form class="hero__form v2 filter mar-bot-30">
                    <div class="row">
            ...
            <div class="col-md-12">
                <div class="row pad-tb-30 align-items-center">
                    <div class="col-lg-7 col-md-12 pad-right-45">
                            ...
                            <ul>
                                <li class="has-sub"><a href="# ">More Filters</a>
                                    <ul class="explore__form-checkbox-list full-filter">
                                        <li class="row">
                                            <div class="col-lg-3 col-12 no-pad-lr">
                                                <div class="filter-checkbox">
                                                    <p>Sort By Features</p>
                                                    <input id="check-a" type="checkbox" name="check">
                                                    <label for="check-a">Open Now</label>
                                                    <input id="check-b" type="checkbox" name="check">
                                                    <label for="check-b">Near me</label>
                                                    <input id="check-c" type="checkbox" name="check">
                                                    <label for="check-c">Child Friendly</label>
                                                    <input id="check-d" type="checkbox" name="check">
                                                    <label for="check-d">Free Parking</label>
                                                    <input id="check-f" type="checkbox" name="check">
                                                    <label for="check-f">Events</label>
                                                    <input id="check-e" type="checkbox" name="check">
                                                    <label for="check-e">Free Wifi</label>
                                                </div>
                                            </div>
                                            <div class="col-lg-3 col-12 no-pad-lr">
                                                <div class="filter-checkbox">
                                            ...
                                            <div class="col-lg-3 col-12 no-pad-lr">
                                                <div class="filter-checkbox filter-sub-area style1">
                                                    <div class="filter-title mar-bot-30">
                                                        <p>Choose distance : <span><input type="text" id="amount"></span></p>
                                                    </div>
                                                    <div id="slider-range" class="price-range mar-bot-20"></div>
                                                    <button class="btn v3  mar-right-5" type="submit">Apply</button>
                                                </div>
                                            </div>
                                        </li>
                                    </ul>
                ...
                <div class="item-wrapper mar-top-10">
                        ...
                        <div id="grid-view" class="tab-pane active  product-grid">
                            <div class="row">
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-12">
                                    <div class="trending-place-item">
                                        <div class="trending-img">
                                            <img src="<?php echo base_url("assets/")?>images/category/places/cafe.jpg" alt="#">
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-12">
                                    <div class="trending-place-item">
                                        <div class="trending-img">
                                            <img src="<?php echo base_url("assets/")?>images/category/places/place-5.jpg" alt="#">
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-12">
                                    <div class="trending-place-item">
                                        <div class="trending-img">
                                            <img src="<?php echo base_url("assets/")?>images/category/places/place-4.jpg" alt="#">
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-12">
                                    <div class="trending-place-item">
                                        <div class="trending-img">
                                            <img src="<?php echo base_url("assets/")?>images/category/places/place-9.jpg" alt="#">
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-12">
                                    <div class="trending-place-item">
                                        <div class="trending-img">
                                            <img src="<?php echo base_url("assets/")?>images/category/places/place-11.jpg" alt="#">
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-12">
                                    <div class="trending-place-item">
                                        <div class="trending-img">
                                            <img src="<?php echo base_url("assets/")?>images/category/event/muay.jpg" alt="#">
                                            <span class="trending-rating-orange">6.5</span>
                                            <span class="save-btn"><i class="icofont-heart"></i></span>
                                        </div>
                                        <div class="trending-title-box">
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-12">
                                    <div class="trending-place-item">
                                        <div class="trending-img">
                                            <img src="<?php echo base_url("assets/")?>images/category/event/photo1.jpg" alt="#">
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-12">
                                    <div class="trending-place-item">
                                        <div class="trending-img">
                                            <img src="<?php echo base_url("assets/")?>images/category/event/coffee.jpg" alt="#">
                                            <span class="trending-rating-green">6.5</span>
                                            <span class="save-btn"><i class="icofont-heart"></i></span>
                                        </div>
                                        <div class="trending-title-box">
                                            <h4><a href="single-listing-two.html">European coffee expo </a></h4>
                                            <div class="customer-review">
                                                <div class="rating-summary float-left">
                                                    <div class="rating-result" title="60%">
                                                        <ul class="product-rating">
